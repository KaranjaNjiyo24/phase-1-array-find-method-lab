...
console.log("Year Denver Broncos won Superbowl: ", superbowlWin(record))
...
// const students = ["Mcdonald", "Benn", "Mercy", "Andrew"]
// students.forEach((student)=> {
//     console.log(student)
// })

// const concatenatedString = students.reduce((accumulator, currentValue) => {
//     return accumulator + " " + currentValue; // Add a space between words
// }, "").trim();
